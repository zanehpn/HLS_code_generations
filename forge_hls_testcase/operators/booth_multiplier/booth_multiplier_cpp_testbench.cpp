...
static ap_int<32> case_x = {};
static ap_int<32> case_y = {};
static ap_int<64> dut_product = {};
static ap_int<64> ref_product = {};
    seed_value(case_x, case_id, 1);
    seed_value(case_y, case_id, 2);
    seed_value(dut_product, case_id, 3);
    copy_value(ref_product, dut_product);

    booth_multiplier(case_x, case_y, dut_product);
    ref::booth_multiplier(case_x, case_y, ref_product);

    if (!compare_storage(dut_product, ref_product)) return 0;
    return 1;
}
