...
static ap_uint<8> dut_input_frame[HEIGHT][WIDTH] = {};
static ap_uint<8> ref_input_frame[HEIGHT][WIDTH] = {};
static ap_uint<8> dut_output_frame[HEIGHT][WIDTH] = {};
static ap_uint<8> ref_output_frame[HEIGHT][WIDTH] = {};
    seed_value(dut_input_frame, case_id, 1);
    seed_value(dut_output_frame, case_id, 2);
    copy_value(ref_input_frame, dut_input_frame);
    copy_value(ref_output_frame, dut_output_frame);

    video_controller(dut_input_frame, dut_output_frame);
    ref::video_controller(ref_input_frame, ref_output_frame);

    if (!compare_storage(dut_input_frame, ref_input_frame)) return 0;
    if (!compare_storage(dut_output_frame, ref_output_frame)) return 0;
    return 1;
}
