...
#include "hcmos_enhanced_floating_point_coprocessor.cpp"
...
static float dut_input1[SIZE] = {};
static float ref_input1[SIZE] = {};
static float dut_input2[SIZE] = {};
static float ref_input2[SIZE] = {};
static float dut_output[SIZE] = {};
static float ref_output[SIZE] = {};
    ...
    hcmos_enhanced_floating_point_coprocessor(dut_input1, dut_input2, dut_output);
    ref::hcmos_enhanced_floating_point_coprocessor(ref_input1, ref_input2, ref_output);
