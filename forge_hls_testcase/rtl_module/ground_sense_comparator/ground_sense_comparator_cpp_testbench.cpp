...
#include "ground_sense_comparator.cpp"
...
static ap_int<1> ref_output[SIZE] = {};
    ...
    ground_sense_comparator(dut_input1, dut_input2, dut_output);
    ref::ground_sense_comparator(ref_input1, ref_input2, ref_output);
