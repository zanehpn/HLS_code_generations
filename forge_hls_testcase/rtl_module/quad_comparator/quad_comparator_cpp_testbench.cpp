...
static ap_int<16> dut_output[ARRAY_SIZE] = {};
static ap_int<16> ref_output[ARRAY_SIZE] = {};
    ...
    seed_value(dut_output, case_id, 5);
    ...
    quad_comparator(dut_input1, dut_input2, dut_input3, dut_input4, dut_output);
    ref::quad_comparator(ref_input1, ref_input2, ref_input3, ref_input4, ref_output);
