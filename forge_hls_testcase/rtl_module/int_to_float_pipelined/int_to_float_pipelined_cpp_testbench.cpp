...
#include "int_to_float_pipelined.cpp"
...
static ap_fixed<32,16> dut_output[SIZE] = {};
static ap_fixed<32,16> ref_output[SIZE] = {};
    ...
    int_to_float_pipelined(dut_input, dut_output);
    ref::int_to_float_pipelined(ref_input, ref_output);
