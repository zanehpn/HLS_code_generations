...
static ap_uint<32> dut_input[SIZE] = {};
static ap_uint<32> ref_input[SIZE] = {};
static ap_uint<32> dut_output[SIZE] = {};
static ap_uint<32> ref_output[SIZE] = {};
    ...
    binary_counter(dut_input, dut_output);
    ref::binary_counter(ref_input, ref_output);
