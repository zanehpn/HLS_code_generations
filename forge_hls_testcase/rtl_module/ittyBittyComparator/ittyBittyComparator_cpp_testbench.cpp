...
#include "ittyBittyComparator.cpp"
...
static ap_int<32> dut_input1[SIZE] = {};
static ap_int<32> ref_input1[SIZE] = {};
static ap_int<32> dut_input2[SIZE] = {};
static ap_int<32> ref_input2[SIZE] = {};
static ap_int<1> dut_output[SIZE] = {};
static ap_int<1> ref_output[SIZE] = {};
    ...
    ittyBittyComparator(dut_input1, dut_input2, dut_output);
    ref::ittyBittyComparator(ref_input1, ref_input2, ref_output);
