...
#include "single_supply_comparator.cpp"
...
static ap_int<1> ref_output[SIZE] = {};
    ...
    single_supply_comparator(dut_input1, dut_input2, dut_output);
    ref::single_supply_comparator(ref_input1, ref_input2, ref_output);
