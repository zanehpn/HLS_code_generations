...
#include "dual_operational_comparator.cpp"
...
static ap_int<16> ref_output[ARRAY_SIZE] = {};
    ...
    seed_value(dut_output, case_id, 3);
    copy_value(ref_input1, dut_input1);
    copy_value(ref_input2, dut_input2);
    copy_value(ref_output, dut_output);

    dual_operational_comparator(dut_input1, dut_input2, dut_output);
    ref::dual_operational_comparator(ref_input1, ref_input2, ref_output);
