...
static ap_int<16> dut_input_array[ARRAY_SIZE] = {};
static ap_int<16> ref_input_array[ARRAY_SIZE] = {};
static ap_int<16> dut_max_value = {};
static ap_int<16> ref_max_value = {};
    seed_value(dut_input_array, case_id, 1);
    seed_value(dut_max_value, case_id, 2);
    copy_value(ref_input_array, dut_input_array);
    copy_value(ref_max_value, dut_max_value);

    single_comparator(dut_input_array, dut_max_value);
    ref::single_comparator(ref_input_array, ref_max_value);

    if (!compare_storage(dut_input_array, ref_input_array)) return 0;
    if (!compare_storage(dut_max_value, ref_max_value)) return 0;
    return 1;
}
