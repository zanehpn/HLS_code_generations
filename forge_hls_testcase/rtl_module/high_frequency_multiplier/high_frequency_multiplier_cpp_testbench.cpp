...
#include "high_frequency_multiplier.cpp"
...
static int dut_input1[SIZE] = {};
static int ref_input1[SIZE] = {};
static int dut_input2[SIZE] = {};
static int ref_input2[SIZE] = {};
static int dut_output[SIZE] = {};
static int ref_output[SIZE] = {};
    ...
    high_frequency_multiplier(dut_input1, dut_input2, dut_output);
    ref::high_frequency_multiplier(ref_input1, ref_input2, ref_output);
