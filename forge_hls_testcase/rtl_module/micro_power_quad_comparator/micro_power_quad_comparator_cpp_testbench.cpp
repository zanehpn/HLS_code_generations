...
#include "micro_power_quad_comparator.cpp"
...
static ap_int<16> dut_input1[ARRAY_SIZE] = {};
static ap_int<16> ref_input1[ARRAY_SIZE] = {};
static ap_int<16> dut_input2[ARRAY_SIZE] = {};
static ap_int<16> ref_input2[ARRAY_SIZE] = {};
static ap_int<16> dut_input3[ARRAY_SIZE] = {};
static ap_int<16> ref_input3[ARRAY_SIZE] = {};
static ap_int<16> dut_input4[ARRAY_SIZE] = {};
static ap_int<16> ref_input4[ARRAY_SIZE] = {};
static ap_int<1> dut_output1[ARRAY_SIZE] = {};
static ap_int<1> ref_output1[ARRAY_SIZE] = {};
static ap_int<1> dut_output2[ARRAY_SIZE] = {};
static ap_int<1> ref_output2[ARRAY_SIZE] = {};
static ap_int<1> dut_output3[ARRAY_SIZE] = {};
static ap_int<1> ref_output3[ARRAY_SIZE] = {};
static ap_int<1> dut_output4[ARRAY_SIZE] = {};
static ap_int<1> ref_output4[ARRAY_SIZE] = {};
    seed_value(dut_input1, case_id, 1);
    seed_value(dut_input2, case_id, 2);
    seed_value(dut_input3, case_id, 3);
    seed_value(dut_input4, case_id, 4);
    seed_value(dut_output1, case_id, 5);
    seed_value(dut_output2, case_id, 6);
    seed_value(dut_output3, case_id, 7);
    seed_value(dut_output4, case_id, 8);
    copy_value(ref_input1, dut_input1);
    copy_value(ref_input2, dut_input2);
    copy_value(ref_input3, dut_input3);
    copy_value(ref_input4, dut_input4);
    copy_value(ref_output1, dut_output1);
    copy_value(ref_output2, dut_output2);
    copy_value(ref_output3, dut_output3);
    copy_value(ref_output4, dut_output4);

    micro_power_quad_comparator(dut_input1, dut_input2, dut_input3, dut_input4, dut_output1, dut_output2, dut_output3, dut_output4);
    ref::micro_power_quad_comparator(ref_input1, ref_input2, ref_input3, ref_input4, ref_output1, ref_output2, ref_output3, ref_output4);

    if (!compare_storage(dut_input1, ref_input1)) return 0;
    if (!compare_storage(dut_input2, ref_input2)) return 0;
    if (!compare_storage(dut_input3, ref_input3)) return 0;
    if (!compare_storage(dut_input4, ref_input4)) return 0;
    if (!compare_storage(dut_output1, ref_output1)) return 0;
    if (!compare_storage(dut_output2, ref_output2)) return 0;
    if (!compare_storage(dut_output3, ref_output3)) return 0;
    if (!compare_storage(dut_output4, ref_output4)) return 0;
    return 1;
}
