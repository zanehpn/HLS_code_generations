...
static ap_uint<32> dut_input_signal[ARRAY_SIZE] = {};
static ap_uint<32> ref_input_signal[ARRAY_SIZE] = {};
static ap_uint<32> dut_output_signal[ARRAY_SIZE] = {};
static ap_uint<32> ref_output_signal[ARRAY_SIZE] = {};
static ap_uint<32> case_multiplier = {};
static ap_uint<32> case_divider = {};
    seed_value(dut_input_signal, case_id, 1);
    seed_value(dut_output_signal, case_id, 2);
    seed_value(case_multiplier, case_id, 3);
    seed_value(case_divider, case_id, 4);
    copy_value(ref_input_signal, dut_input_signal);
    copy_value(ref_output_signal, dut_output_signal);

    pll_clock(dut_input_signal, dut_output_signal, case_multiplier, case_divider);
    ref::pll_clock(ref_input_signal, ref_output_signal, case_multiplier, case_divider);

    if (!compare_storage(dut_input_signal, ref_input_signal)) return 0;
    if (!compare_storage(dut_output_signal, ref_output_signal)) return 0;
    return 1;
}
