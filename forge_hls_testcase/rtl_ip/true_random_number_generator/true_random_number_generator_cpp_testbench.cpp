...
#include "true_random_number_generator.cpp"
...
static ap_uint<32> case_seed = {};
static ap_uint<32> dut_output[ARRAY_SIZE] = {};
static ap_uint<32> ref_output[ARRAY_SIZE] = {};
    seed_value(case_seed, case_id, 1);
    seed_value(dut_output, case_id, 2);
    copy_value(ref_output, dut_output);

    true_random_number_generator(case_seed, dut_output);
    ref::true_random_number_generator(case_seed, ref_output);
