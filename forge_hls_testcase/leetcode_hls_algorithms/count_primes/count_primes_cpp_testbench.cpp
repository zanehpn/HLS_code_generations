...
static int dut_count = {};
static int ref_count = {};
    seed_value(case_limit, case_id, 1);
    seed_value(dut_count, case_id, 2);
    copy_value(ref_count, dut_count);

    count_primes(case_limit, dut_count);
    ref::count_primes(case_limit, ref_count);
