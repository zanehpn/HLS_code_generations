...
{
#pragma HLS ARRAY_PARTITION variable=level_counts type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=level type=cyclic dim=1 factor=8
#pragma HLS ARRAY_PARTITION variable=edges type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=nodes type=cyclic dim=1 factor=4
  node_index_t n;
  edge_index_t e;
  level_t horizon;
  edge_index_t cnt;
